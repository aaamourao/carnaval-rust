...
pub struct Dense {
    pub layers: Array<f64, Ix2>,
    pub bias: Array<f64, Ix2>,
...
impl Dense {
    pub fn new(input_dim: usize,
        ...
        let layers = Array::random((input_dim, output_dim), Uniform::new(0.0, 1.0));
        let bias = Array::random((1, output_dim), Uniform::new(0.0, 1.0));
...
impl Layer for Dense {
    ...
    fn forward(&self, input: Array<f64, Ix2>) -> Array<f64, Ix2> {
        return self.layers.mul(input).add(&self.bias)
    }
}
